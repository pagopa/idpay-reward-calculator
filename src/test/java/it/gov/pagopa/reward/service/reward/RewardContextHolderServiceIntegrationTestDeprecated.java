//package it.gov.pagopa.reward.service.reward; todo transform
//
...
//                        new HashMap<>(Map.of(
//                                "INITIATIVE1",
//                                new UserInitiativeCounters(trx.getUserId(), InitiativeGeneralDTO.BeneficiaryTypeEnum.PF,"INITIATIVE1")
//                        ))
//                )
//                .build();
//
