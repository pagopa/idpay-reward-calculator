...
public class HpanInitiativesAtomicOpsRepositoryImpl implements HpanInitiativesAtomicOpsRepository {
    ...
    public Mono<UpdateResult> createIfNotExist(HpanInitiatives hpanInitiatives) {
      return MongoRequestRateTooLargeRetryer.withRetry(createIfNotExistInner(hpanInitiatives), MongoRequestRateTooLargeUtilities.maxRetry, MongoRequestRateTooLargeUtilities.maxMillisElapsed);
    }

    public Mono<UpdateResult> createIfNotExistInner(HpanInitiatives hpanInitiatives) {
    ...
    public Mono<UpdateResult> setInitiative(String hpan, OnboardedInitiative onboardedInitiative) {
      return MongoRequestRateTooLargeRetryer.withRetry(setInitiativeInner(hpan, onboardedInitiative), MongoRequestRateTooLargeUtilities.maxRetry, MongoRequestRateTooLargeUtilities.maxMillisElapsed);
    }

    public Mono<UpdateResult> setInitiativeInner(String hpan, OnboardedInitiative onboardedInitiative) {
