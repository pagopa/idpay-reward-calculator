...
@Service
@Slf4j
public class TransactionConsumerImpl extends BaseKafkaConsumer<RewardTransactionDTO, UserInitiativeCounters>  implements TransactionConsumer {
    ...
    public TransactionConsumerImpl(@Value("${spring.application.name}") String applicationName,
