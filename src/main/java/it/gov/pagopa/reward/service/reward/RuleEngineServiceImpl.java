...
public class RuleEngineServiceImpl implements RuleEngineService {
    ...
    public RuleEngineServiceImpl(RuleEngineConfig ruleEngineConfig,
                                 ...
                                 TransactionDroolsDTO2RewardTransactionMapper transactionDroolsDTO2RewardTransactionMapper, TransactionProcessedRepository transactionProcessedRepository) {
        ...
        transactionProcessedRepository.findById(transaction.getIdTrxAcquirer())
                .flatMap(result -> {
                    if(result != null) {
                        ...
                        log.info("[DUPLICATE_TRX] Already processed trx {}", result);
                        trx.getRejectionReasons().add(RewardConstants.TRX_REJECTION_REASON_DUPLICATE);
                    }
