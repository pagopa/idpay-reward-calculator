...
public class RewardCalculatorMediatorServiceImpl implements RewardCalculatorMediatorService {
    ...
    public Flux<RewardTransactionDTO> execute(Flux<Message<String>> messageFlux) {
        return messageFlux
                ...
                .subscribe(p -> p.ifPresent(Acknowledgment::acknowledge));
    }
    ...
    public Mono<Optional<Acknowledgment>> execute(Pair<Message<String>, Integer> messageAndLockId) {
        ...
        return Mono.just(message)
                ...
                .map(r -> Optional.ofNullable(message.getHeaders().get(KafkaHeaders.ACKNOWLEDGMENT, Acknowledgment.class)))
