...
public interface InitiativesEvaluatorFacadeService {
    ...
    Mono<Pair<UserInitiativeCountersWrapper, RewardTransactionDTO>> evaluateInitiativesBudgetAndRules(TransactionDTO trx, List<String> initiatives, UserInitiativeCountersWrapper userCounters);
